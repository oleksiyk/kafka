...
Client.prototype._offsetFetchRequest = function(apiVersion, groupId, requests) {
    var self = this;
...
Client.prototype.offsetFetchRequestV0 = function(groupId, requests) {
    return this._offsetFetchRequest(0, groupId, requests);
};

Client.prototype.offsetFetchRequestV2 = function(groupId, requests) {
    return this._offsetFetchRequest(2, groupId, requests);
};
