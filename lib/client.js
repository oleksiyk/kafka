...
Client.prototype.fetchRequest = function (requests) {
    ...
    return self._metadata().then(function () {
        ...
        .then(function (topics) {
            return _mapTopics(topics).map(function (r) {
                if (r.messageSet.length === 1 && r.messageSet[0].message.attributes.codec !== 0) {
                    try {
                        r.messageSet = self._decompressMessage(r.messageSet[0].message);
                    } catch (err) {
...
Client.prototype._decompressMessage = function (message) {
