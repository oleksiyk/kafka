...
function GroupConsumerStream(options) {
    ...
    this.groupConsumer = new GroupConsumer(options);
    this._end = _.bind(this.groupConsumer.end, this.groupConsumer);
    this.init = _.bind(this.groupConsumer.init, this.groupConsumer);
    this.fetchOffset = _.bind(this.groupConsumer.fetchOffset, this.groupConsumer);
    this._commitOffset = _.bind(this.groupConsumer.commitOffset, this.groupConsumer);
}
